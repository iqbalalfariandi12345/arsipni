...
$isi = query("SELECT * FROM kategori WHERE id_kategori = $id")[0];
...
if (isset($_POST['submit'])) {
	...
	if (ubahKategori($_POST) > 0) {
		...
		echo "<script>
				...
				document.location.href = 'ubah_kategori.php';
			</script>
		";
	}
}
						...
						<div class="row">
							<div class="col">
								...
								<div class="form-group">
									...
									<input type="text" name="nama_kategori" class="form-control" required value="<?= $isi['nama_kategori']; ?>">
								</div>
							</div>
						</div>
						<div class="form-group">
